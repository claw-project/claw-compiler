    ...
    extends TestCase 
{
    ...
    public void testScanFortranFiles() throws Exception
    {
        ...
        {   
            ...
            Map<Path, List<Path>> dirFileLists = Collections.singletonMap(tmpDir, 
                                                                          Arrays.asList(fPath1, fPath2));
            ...
            Map<Path,  BuildInfo.FortranFileInfo> expRes;
            {
                ...
                expRes.put(fPath1, new BuildInfo.FortranFileInfo(Arrays.asList("a", "b"),
                                                                 Arrays.asList("c", "d", "e"), 
            ...
            {//Normal
                ...
                for(int i = 0 ; i < n; ++i)
                {
                    ...
                    expRes.put(fPathi, new BuildInfo.FortranFileInfo(Arrays.asList("a", "b"),
                                                                     Arrays.asList("c", "d", "e"), 
                                                                     Files.getLastModifiedTime(fPathi)));
    ...
    public void testGetFilesDependencies() throws Exception
    {
        ...
        {   
            ...
            Path a = tmpDir.resolve("a.f"), 
                    b = tmpDir.resolve("b.f"),
                    c = tmpDir.resolve("c.f"),
                    d = tmpDir.resolve("d.f");
            {//Normal
                {
                    fileInfo = new HashMap<Path,  BuildInfo.FortranFileInfo>();
                    fileInfo.put(a, new BuildInfo.FortranFileInfo(Arrays.asList("a"),
                                                                  Arrays.asList("b"), 
                                                                  FileTime.fromMillis(0)));
                    fileInfo.put(b, new BuildInfo.FortranFileInfo(Arrays.asList("b"),
                                                                  Arrays.asList("c", "d"), 
                                                                  FileTime.fromMillis(0)));
                    fileInfo.put(c, new BuildInfo.FortranFileInfo(Arrays.asList("c"),
                                                                Arrays.asList(), 
                                                                FileTime.fromMillis(0)));
                    fileInfo.put(d, new BuildInfo.FortranFileInfo(Arrays.asList("d"),
                                                                Arrays.asList(), 
                                                                FileTime.fromMillis(0)));
                }
            ...
            {//Double definition
                {
                    ...
                    fileInfo.put(a, new BuildInfo.FortranFileInfo(Arrays.asList("a"),
                                                                  Arrays.asList("b"), 
                                                                  FileTime.fromMillis(0)));
                    fileInfo.put(b, new BuildInfo.FortranFileInfo(Arrays.asList("a", "b"),
                                                                  Arrays.asList(), 
                                                                  FileTime.fromMillis(0)));
                }
                boolean exceptionCaught = false;
    ...
    public void testBuildinfo() throws Exception
    {
        ...
        {   
            ...
            Map<Path,  BuildInfo.FortranFileInfo> expFileInfo;
            {
                ...
                expFileInfo.put(fPath1, new BuildInfo.FortranFileInfo(Arrays.asList("a", "a1"),
                                                                 Arrays.asList("b"), 
                                                                 Files.getLastModifiedTime(fPath1)));
                expFileInfo.put(fPath2, new BuildInfo.FortranFileInfo(Arrays.asList("b"),
                                                                 Arrays.asList(), 
                                                                 Files.getLastModifiedTime(fPath2)));
            }
