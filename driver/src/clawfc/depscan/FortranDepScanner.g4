...
FUNCTION_OPEN_STMT : SEP? (SUBROUTINE_SPECIFIER SEP)* RETURN_TYPE? FUNCTION SEP IDENTIFIER SEP? PROCEDURE_ARGS SEP?
                     (FUNCTION_RESULT SEP?)?;
SUBROUTINE_OPEN_STMT : SEP? (SUBROUTINE_SPECIFIER SEP)* SUBROUTINE SEP IDENTIFIER SEP? (PROCEDURE_ARGS SEP?)?;
