...
public class ClawEnumTest {
  ...
  public void TargetTest() {
    ...
    assertEquals(Arrays.asList(TatsuConstant.TARGET_CPU,
        TatsuConstant.TARGET_GPU, TatsuConstant.TARGET_MIC,
        TatsuConstant.TARGET_FPGA, TatsuConstant.TARGET_NONE),
