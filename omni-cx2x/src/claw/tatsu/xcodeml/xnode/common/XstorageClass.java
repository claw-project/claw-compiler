...
public enum XstorageClass {
  AUTO(Xname.SCLASS_AUTO),
  EXTERN(Xname.SCLASS_EXTERN),
  EXTERN_DEF(Xname.SCLASS_EXTERN_DEF),
  F_LOCAL(Xname.SCLASS_F_LOCAL),
  F_FUNC(Xname.SCLASS_F_FUNC),
  F_PARAM(Xname.SCLASS_F_PARAM),
  LABEL(Xname.SCLASS_LABEL),
