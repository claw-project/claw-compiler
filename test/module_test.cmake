...
add_custom_target(
  clean-mod-file-${TEST_NAME}-gpu
  COMMAND rm -f *.mod
)
add_custom_target(
  clean-mod-file-${TEST_NAME}-cpu
  COMMAND rm -f *.mod
)
...
add_dependencies(${EXECUTABLE_TRANSFORMED_CPU} clean-mod-file-${TEST_NAME}-cpu)
add_dependencies(${EXECUTABLE_TRANSFORMED_GPU} clean-mod-file-${TEST_NAME}-gpu)
