PROGRAM serialize
 ...
 CALL fs_write_field ( ppser_serializer , ppser_savepoint ,"banana1-input_a" ,&
  a )
 CALL fs_write_field ( ppser_serializer , ppser_savepoint ,"banana1-input_aa"&
  , aa )
 CALL fs_write_field ( ppser_serializer , ppser_savepoint ,"banana1-input_aaa"&
  , aaa )
 CALL fs_write_field ( ppser_serializer , ppser_savepoint ,"banana1-input_c" ,&
  c )
 CALL fs_write_field ( ppser_serializer , ppser_savepoint ,"banana1-input_cc"&
  , cc )
 CALL fs_write_field ( ppser_serializer , ppser_savepoint ,"banana1-input_ccc"&
  , ccc )
