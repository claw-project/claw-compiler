...
function(claw_add_advanced_test_set)
  ...
  cmake_parse_arguments(claw_add_advanced_test_set "" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})
...
function(claw_add_advanced_test)
  ...
  cmake_parse_arguments(claw_add_advanced_test "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})
  ...
  set(OUTPUT_FILE_CPU ${claw_add_advanced_test_WORKING_DIRECTORY}/transformed_code_cpu.f90)
  set(OUTPUT_FILE_GPU ${claw_add_advanced_test_WORKING_DIRECTORY}/transformed_code_gpu.f90)
  set(REFERENCE_FILE_CPU ${claw_add_advanced_test_WORKING_DIRECTORY}/reference_cpu.f90)
  set(REFERENCE_FILE_GPU ${claw_add_advanced_test_WORKING_DIRECTORY}/reference_gpu.f90)
  set(OUTPUT_MAIN_CPU ${claw_add_advanced_test_WORKING_DIRECTORY}/transformed_main_cpu.f90)
  set(OUTPUT_MAIN_GPU ${claw_add_advanced_test_WORKING_DIRECTORY}/transformed_main_gpu.f90)
  set(REFERENCE_MAIN_CPU ${claw_add_advanced_test_WORKING_DIRECTORY}/reference_main_cpu.f90)
  set(REFERENCE_MAIN_GPU ${claw_add_advanced_test_WORKING_DIRECTORY}/reference_main_gpu.f90)

  # If the test case has an extra module.
  if(EXISTS ${claw_add_advanced_test_WORKING_DIRECTORY}/mo_column_extra.f90)
    set(ORIGINAL_FILE_EXTRA ${claw_add_advanced_test_WORKING_DIRECTORY}/mo_column_extra.f90)
    set(OUTPUT_FILE_EXTRA_CPU ${claw_add_advanced_test_WORKING_DIRECTORY}/transformed_code_extra_cpu.f90)
    set(OUTPUT_FILE_EXTRA_GPU ${claw_add_advanced_test_WORKING_DIRECTORY}/transformed_code_extra_gpu.f90)
    set(REFERENCE_FILE_EXTRA_CPU ${claw_add_advanced_test_WORKING_DIRECTORY}/reference_extra_cpu.f90)
    set(REFERENCE_FILE_EXTRA_GPU ${claw_add_advanced_test_WORKING_DIRECTORY}/reference_extra_gpu.f90)
  endif()
  ...
  # Add target to the global build/clean target
  add_dependencies(${BUILD_TEST_TARGET} transform-${claw_add_advanced_test_NAME})
  add_dependencies(${CLEAN_TEST_TARGET} clean-${claw_add_advanced_test_NAME})
  add_dependencies(${BUILD_TEST_TARGET}-${TEST_SET} transform-${claw_add_advanced_test_NAME})
  add_dependencies(${CLEAN_TEST_TARGET}-${TEST_SET} clean-${claw_add_advanced_test_NAME})
  ...
  if(NOT IGNORE)
    # Compare reference transformed code and output of the transformation
    add_test(NAME ast-compare-cpu-${claw_add_advanced_test_NAME} COMMAND diff --ignore-blank-lines ${OUTPUT_FILE_CPU} ${REFERENCE_FILE_CPU})
    add_test(NAME ast-compare-gpu-${claw_add_advanced_test_NAME} COMMAND diff --ignore-blank-lines ${OUTPUT_FILE_GPU} ${REFERENCE_FILE_GPU})
    add_test(NAME ast-compare-main-cpu-${claw_add_advanced_test_NAME} COMMAND diff --ignore-blank-lines ${OUTPUT_MAIN_CPU} ${REFERENCE_MAIN_CPU})
    add_test(NAME ast-compare-main-gpu-${claw_add_advanced_test_NAME} COMMAND diff --ignore-blank-lines ${OUTPUT_MAIN_GPU} ${REFERENCE_MAIN_GPU})
    set_tests_properties(ast-compare-cpu-${claw_add_advanced_test_NAME} PROPERTIES DEPENDS ast-transform-${claw_add_advanced_test_NAME})
    set_tests_properties(ast-compare-gpu-${claw_add_advanced_test_NAME} PROPERTIES DEPENDS ast-transform-${claw_add_advanced_test_NAME})
    set_tests_properties(ast-compare-main-cpu-${claw_add_advanced_test_NAME} PROPERTIES DEPENDS ast-transform-${claw_add_advanced_test_NAME})
    set_tests_properties(ast-compare-main-gpu-${claw_add_advanced_test_NAME} PROPERTIES DEPENDS ast-transform-${claw_add_advanced_test_NAME})

    # Test the extra module file with its reference
    if(EXISTS ${claw_add_advanced_test_WORKING_DIRECTORY}/mo_column_extra.f90)
      add_test(NAME ast-compare-cpu-extra-${claw_add_advanced_test_NAME} COMMAND diff --ignore-blank-lines ${OUTPUT_FILE_EXTRA_CPU} ${REFERENCE_FILE_EXTRA_CPU})
      add_test(NAME ast-compare-gpu-extra-${claw_add_advanced_test_NAME} COMMAND diff --ignore-blank-lines ${OUTPUT_FILE_EXTRA_GPU} ${REFERENCE_FILE_EXTRA_GPU})
      set_tests_properties(ast-compare-cpu-extra-${claw_add_advanced_test_NAME} PROPERTIES DEPENDS ast-transform-${claw_add_advanced_test_NAME})
      set_tests_properties(ast-compare-gpu-extra-${claw_add_advanced_test_NAME} PROPERTIES DEPENDS ast-transform-${claw_add_advanced_test_NAME})
    endif()
    ...
    if(OUTPUT)
      ...
      add_test(NAME compare-output-gpu-${claw_add_advanced_test_NAME} COMMAND bash -c "diff ${TEST_PARAMETERS_GPU}")
    endif()
  endif()
