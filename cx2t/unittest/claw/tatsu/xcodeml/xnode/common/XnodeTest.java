...
public class XnodeTest {
  ...
  private static final String ARG_1 = "<FarrayRef type=\"A7f899b41b220\">" +
  ...
  private static final String ARG_2 = "<FarrayRef type=\"A7f899b41b220\">" +
      "<varRef type=\"A7f899b411d50\">" +
  ...
  private static final String ARG_3 = "<FarrayRef type=\"A7fef50d1c8a0\">" +
  ...
  private static final String ARG_6 = "<FarrayRef type=\"A7fef50d1c8a0\">" +
      "<varRef type=\"A7fef50d1bc20\">" +
      ...
      "<indexRange is_assumed_shape=\"true\"></indexRange></FarrayRef>";
  private static final String ARG_7 = "<FarrayRef type=\"A7fb5db2d0b80\">" +
      ...
      "<indexRange is_assumed_shape=\"true\"></indexRange></FarrayRef>";
  private static final String ARG_8 = "<FarrayRef type=\"A7fb5db2e6200\">" +
      ...
      "<indexRange is_assumed_shape=\"true\"></indexRange></FarrayRef>";
  private static final String ARG_9 = "<FarrayRef type=\"A7f899b41b220\">" +
      "<varRef type=\"A7f899b411d50\">" +
      "<Var scope=\"local\" type=\"A7f899b411d50\">q</Var></varRef>" +
      "<indexRange is_assumed_shape=\"true\"/></FarrayRef>";
  private static final String ARG_10 = "<FarrayRef type=\"A7f899b41b220\">" +
      "<varRef type=\"A7f899b411d50\">" +
      "<Var scope=\"local\" type=\"A7f899b411d50\">q</Var></varRef>" +
      "</FarrayRef>";
