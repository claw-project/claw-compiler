 ...
 */
public enum Xattr {
  ATTR(Xname.ATTR_ATTR),
  BIND(Xname.ATTR_BIND),
  BIND_NAME(Xname.ATTR_BIND_NAME),
  ...
  IS_ABSTRACT(Xname.ATTR_IS_ABSTRACT),
  IS_ALLOCATABLE(Xname.ATTR_IS_ALLOCATABLE),
  IS_ASSIGNMENT(Xname.ATTR_IS_ASSIGNMENT),
  IS_ASSUMED_SIZE(Xname.ATTR_IS_ASSUMED_SIZE),
  IS_ASSUMED_SHAPE(Xname.ATTR_IS_ASSUMED_SHAPE),
  IS_ASYNCHRONOUS(Xname.ATTR_IS_ASYNCHRONOUS),
  IS_CLASS(Xname.ATTR_IS_CLASS),
  IS_COMPLEX_PART(Xname.ATTR_IS_COMPLEX_PART),
  IS_CONTIGUOUS(Xname.ATTR_IS_CONTIGUOUS),
  IS_DEFERRED(Xname.ATTR_IS_DEFERRED),
  IS_DEFINED_IO(Xname.ATTR_IS_DEFINED_IO),
  IS_ELEMENTAL(Xname.ATTR_IS_ELEMENTAL),
  IS_EXTERNAL(Xname.ATTR_IS_EXTERNAL),
  IS_INTERNAL(Xname.ATTR_IS_INTERNAL),
  IS_INTERNAL_PRIVATE(Xname.ATTR_IS_INTERNAL_PRIVATE),
  IS_INTRINSIC(Xname.ATTR_IS_INTRINSIC),
  IS_NON_OVERRIDABLE(Xname.ATTR_IS_NON_OVERRIDABLE),
  ...
  IS_PROCEDURE(Xname.ATTR_IS_PROCEDURE),
  IS_PROGRAM(Xname.ATTR_IS_PROGRAM),
  IS_PROTECTED(Xname.ATTR_IS_PROTECTED),
  IS_PUBLIC(Xname.ATTR_IS_PUBLIC),
  IS_PURE(Xname.ATTR_IS_PURE),
  IS_RECURSIVE(Xname.ATTR_IS_RECURSIVE),
  IS_SAVE(Xname.ATTR_IS_SAVE),
  IS_SEQUENCE(Xname.ATTR_IS_SEQUENCE),
  IS_SUB(Xname.ATTR_IS_SUB),
  IS_TARGET(Xname.ATTR_IS_TARGET),
  IS_VALUE(Xname.ATTR_IS_VALUE),
  IS_VOLATILE(Xname.ATTR_IS_VOLATILE),
  KIND(Xname.ATTR_KIND),
  LABEL_NAME(Xname.ATTR_LABEL_NAME),
  LANGUAGE(Xname.ATTR_LANGUAGE),
  LINENO(Xname.ATTR_LINENO),
  LOCAL_NAME(Xname.ATTR_LOCAL_NAME),
  MEMBER(Xname.ATTR_MEMBER),
  MESSAGE(Xname.ATTR_MESSAGE),
  NAME(Xname.ATTR_NAME),
  PARENT_NAME(Xname.ATTR_PARENT_NAME),
  PASS(Xname.ATTR_PASS),
  PASS_ARG_NAME(Xname.ATTR_PASS_ARG_NAME),
  ...
  STAT_NAME(Xname.ATTR_STAT_NAME),
  ...
  IS_LOCKED(Xname.ATTR_IS_LOCKED),
  PROMOTION_INFO(Xname.ATTR_PROMOTION_INFO),
  WAS_ELEMENTAL(Xname.ATTR_WAS_ELEMENTAL);
