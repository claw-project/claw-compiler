...
public final class DirectedGraph<T> implements Iterable<T>
{
    ...
    /**
     * Given a start node, and a destination, adds an arc from the start node to the
     * destination. If an arc already exists, this operation is a no-op. If either
     * endpoint does not exist in the graph, throws a NoSuchElementException.
     *
     * @param start The start node.
     * @param dest  The destination node.
     * @throws NoSuchElementException If either the start or destination nodes do
     *                                not exist.
     */
    ...
    /**
     * Given two nodes in the graph, returns whether there is an edge from the first
     * node to the second node. If either node does not exist in the graph, throws a
