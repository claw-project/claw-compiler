...
\begin{lstlisting}[label=lst:add_node, language=Java, caption=XcodeML add node example]
...
\begin{lstlisting}[label=lst:update_node, language=Java, caption=XcodeML update node example]
public void transform(XcodeProgram xcodeml, Transformer transformer,
                      Transformation other)
{                      
